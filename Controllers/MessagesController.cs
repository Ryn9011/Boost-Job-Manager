...
namespace JobTracker.API.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        public MessagesController(MessageRepository repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
        ...
        [HttpGet]
        public IActionResult GetMessagesForUser(int userId, MessageParams messageParams)
        {
             if (userId != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))
                return Unauthorized();
            
            var messagesFromRepo = _repo.GetMessagesForUser(messageParams);
